    ...
    >
      <div className='w-full max-w-4xl text-center'>
        ...
        <div className='flex flex-col sm:flex-row gap-4 justify-center'>
          <Link
            href='/auth/login'
            className='px-8 py-4 text-white rounded-lg font-medium transition-colors hover:opacity-90'
          ...
          <Link
            href='/auth/register'
            className='px-8 py-4 border-2 rounded-lg font-medium transition-colors text-white hover:opacity-90'
            style={{
              borderColor: '#5F72D9',
