    ...
    <Layout>
                ...
                <div className="glass-card rounded-2xl p-6 bg-card/10 backdrop-blur-xl border-primary-foreground/10">
                  <div className="space-y-4">
                    <div className="flex items-center gap-4 p-4 rounded-xl bg-income/20">
                      ...
                      <span className="text-primary-foreground">Salario depositado</span>
                      <span className="ml-auto font-bold text-income">+$5,000,000</span>
                    </div>
                    <div className="flex items-center gap-4 p-4 rounded-xl bg-expense/20">
                      ...
                      <span className="text-primary-foreground">Pago de arriendo</span>
                      <span className="ml-auto font-bold text-expense">-$1,500,000</span>
                    </div>
                    <div className="flex items-center gap-4 p-4 rounded-xl bg-savings/20">
                      ...
                      <span className="text-primary-foreground">Ahorro mensual</span>
                      <span className="ml-auto font-bold text-savings">-$500,000</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <footer className="border-t border-border py-8">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>© 2024 yMoney. Gestiona tus finanzas con inteligencia.</p>
        </div>
      </footer>
    </Layout>
  );
