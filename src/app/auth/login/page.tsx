        ...
        <div className='bg-white rounded-lg shadow-lg p-8'>
          ...
          <div className='mt-6'>
            ...
            <button
              ...
              disabled={loading}
              className='mt-6 w-full py-3 border-2 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 flex items-center justify-center gap-2'
              style={{
                borderColor: '#5F72D9',
                color: '#233ED9',
                backgroundColor: '#fff',
