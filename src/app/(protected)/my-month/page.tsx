...
const initialTransactions: Transaction[] = [
  ...
  },
  {
    id: '5',
    type: 'savings',
    description: 'Transferencia a CDT',
    amount: 500000,
    date: '16 Ene',
  },
  {
    ...
    <>
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8'>
          ...
          <Button
            variant='hero'
            onClick={() => handleAddTransaction('regular_expense')}
          >
            Nueva Transacción
          </Button>
        </div>
        ...
        <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8'>
          ...
          <BalanceCard
            ...
            variant='income'
            subtitle={`${
              transactions.filter((t) => t.type.includes('income')).length
            } transacciones`}
          />
          <BalanceCard
            title='Total Gastos'
            ...
            variant='expense'
            subtitle={`${
              transactions.filter((t) => t.type.includes('expense')).length
            } transacciones`}
          />
          <BalanceCard
            title='Balance Final'
